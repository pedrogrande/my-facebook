...
class StatusUpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status_update" do
    assert_difference('StatusUpdate.count') do
      post status_updates_url, params: { status_update: { content: @status_update.content, title: @status_update.title, user_id: @status_update.user_id } }
    end
  ...
  test "should update status_update" do
    patch status_update_url(@status_update), params: { status_update: { content: @status_update.content, title: @status_update.title, user_id: @status_update.user_id } }
